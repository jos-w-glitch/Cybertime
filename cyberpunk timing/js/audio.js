const AudioEngine = {
  ...
  _playProceduralTrack(trackId, bpm) {
    const palettes = {
      track2: { bass: 55, lead: 220, pad: 330 },
      track3: { bass: 65, lead: 277, pad: 415 },
      track4: { bass: 73, lead: 311, pad: 466 },
      track5: { bass: 82, lead: 349, pad: 523 },
    };
    const p = palettes[trackId] || palettes.track2;
